        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="g-mb-25 fadeInUp u-in-viewport" data-animation="fadeInUp" data-animation-delay="500" data-animation-duration="1500" style="animation-duration: 1500ms;">
                     <!--  <span class="d-block g-color-black g-font-size-25 mb-3 g-text-strike">Horarios de reuniones Domingos</span>!-->
                  
                    <div class="u-shadow-v1-5 alert fade show g-brd-around  g-bg-white rounded-0"  role="alert" >
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="d-flex justify-content-between">
                                    <p class="m-0 g-color-black g-font-size-20"><span>Las reuniones son todos los Domingos en nuestro canal de Youtube </span>
                                    <span>a las <i class="icon-hotel-restaurant-003 u-line-icon-pro"></i>  11:30 hrs.  </span>
                                    </p>
                                </div>
                                <p class="m-0 g-font-size-14 g-color-black"> 
                                <a href="https://www.youtube.com/user/IgUnionCristiana/" target="_blank" class="btn btn-md u-btn-outline-black g-mr-10 g-mb-15">No te lo pierdas, visita nuestro canal </a>                            
                               </p>
                            </div>
                        </div>
                    </div>
