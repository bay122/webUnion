...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('uc2/vendor/hs-megamenu/src/hs.megamenu.css') }}">
...
<body>
    ...
    <script src="{{ asset('uc2/vendor/hs-megamenu/src/hs.megamenu.js')}}"></script>
    ...
    <script src="{{ asset('uc2/js/components/hs.tabs.js')}}"></script>
    ...
    <script>
      $(document).ready(function() {
          ...
          @if ( !isCurrentRoute('login') )
            ...
            <a class="js-go-to  u-icon-v3 g-bg-youtube g-color-white g-color-white--hover  g-rounded-50x g-mr-20 g-mb-20" href="#!" data-type="fixed" data-position='{
                "bottom": 500,
                "right": -20
            }'>
            ...
            <a class="js-go-to  u-icon-v3 g-bg-facebook g-color-white g-color-white--hover  g-rounded-50x g-mr-20 g-mb-20" href="#!" data-type="fixed" data-position='{
                "bottom": 444,
                "right": -20
            }'>
            ...
            <a class="js-go-to  u-icon-v3 g-bg-instagram g-color-white g-color-white--hover  g-rounded-50x g-mr-20 g-mb-20" href="#!" data-type="fixed" data-position='{
                "bottom": 388,
                "right": -20
            }'>
            ...
            <a class="js-go-to  u-icon-v3 g-bg-twitter g-color-white g-color-white--hover  g-rounded-50x g-mr-20 g-mb-20" href="#!" data-type="fixed" data-position='{
                "bottom": 332,
                "right": -20
            }'>
            ...
            setTimeout(()=>{$('.social').show('slow')},500);
          @endif
