                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group {{ $errors->has('id_llegada_iglesia') ? 'has-error' : '' }}">
                                    <label for="id_llegada_iglesia" class="col-xs-12 g-color-gray-dark-v2 g-font-size-15">Región</label>
                                    <div class="col-xs-12">
                                        <select id="id_llegada_iglesia" name="id_llegada_iglesia" class="form-control select2">
                                            @foreach($rangoLlegadaIglesia as $rango)
                                            <option value="{{ $rango->id_llegada_iglesia }}">{{ $rango->gl_nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
