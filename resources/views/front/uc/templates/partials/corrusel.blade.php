    ...
    <div class="row">
        <div class="owl-slider col-md-12 col-sm-12 col-xs-12">
            <div id="owl-slider-style-2" class="owl-slider-style-2 owl-carousel overflow-hidden paperio-feature-style2 owl-square-pagination pagination-light-style owl-next-prev-arrow-style2 owl-cursor-light slide-item-1">
                <!--div class="item text-center cover-background bg-image-srcset" style="background: url({{ asset('images/02/slider-01-new-1024x675.jpg') }});" data-bg-srcset="http://wpdemos.themezaa.com/paperio/anchali/wp-content/uploads/2016/02/slider-01-new-1024x675.jpg 1024w, http://wpdemos.themezaa.com/paperio/anchali/wp-content/uploads/2016/02/slider-01-new-420x277.jpg 420w, http://wpdemos.themezaa.com/paperio/anchali/wp-content/uploads/2016/02/slider-01-new-768x506.jpg 768w, http://wpdemos.themezaa.com/paperio/anchali/wp-content/uploads/2016/02/slider-01-new.jpg 1170w, http://wpdemos.themezaa.com/paperio/anchali/wp-content/uploads/2016/02/slider-01-new-81x53.jpg 81w">
                            ...
                            <div class="inner">
                                <div class="" style="display: inline-grid;">
                                    <p class="banner-date2 banner-date2-line margin-five-bottom xs-margin-two-bottom letter-spacing-3 text-extra-small text-uppercase featured-style-meta">
                                        <span>
                                            <a rel="category tag" class="text-white featured-style-meta-link" href="category/news-magazine/its-thinking-time/index.html">Ultima noticia Misiones</a>
                                        </span>
                                    </p>
                                    <a href="news-you-can-use/index.html" class="btn btn-color btn-small text-uppercase alt-font">Leer Nota
                ...
                <div class="item text-center cover-background bg-image-srcset" style="background: url({{ asset('images/carrousel/editorial.jpg') }});">
                    <div class="opacity-light bg-black overlay-layer"></div>
                    <div class="outer">
                        <div class="middle">
                            <div class="inner">
                ...
                <div class="item text-center cover-background bg-image-srcset" style="background: url({{ asset('images/carrousel/ministerios.jpg') }});">
                    <div class="opacity-light bg-black overlay-layer"></div>
                    <div class="outer">
                        <div class="middle">
                            <div class="inner">
                                <div class="" style="display: inline-grid;">
                                    <p class="banner-date2 banner-date2-line margin-five-bottom xs-margin-two-bottom letter-spacing-3 text-extra-small text-uppercase featured-style-meta">
                                        <span>
                                            <a rel="category tag" class="text-white featured-style-meta-link" href="articles/ministerios">Ultima noticia Ministerio</a>
                                        </span>
                                    </p>
