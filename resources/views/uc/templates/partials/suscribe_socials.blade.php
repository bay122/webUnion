                            ...
                            <div class="form-fields">
                                <div class="news-box">
                                    ...
                                    <div class="input-group">
                                        <input type="email" placeholder="Ingresa tu dirección de Email" class="form-control fl-left" required/>
                                        <button type="submit" class="btn btn-default fl-right text-mid-gray">
