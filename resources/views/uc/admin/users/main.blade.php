            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center"><span class="text-extra-small text-uppercase alt-font right-separator blog-single-page-meta">Administrador</span>
                        <h2 class="title-small position-reletive font-weight-700 text-uppercase text-mid-gray blog-headline right-separator entry-title blog-single-page-title no-margin-bottom">@yield('page', 'Usuarios')</h2>
                    </div>
                </div>
            </div>
        </section>
        @include('flash::message')
        <!-- INICIO CONTENT ADMIN USERS-->
        @yield('content_admin_users')
        <!-- FIN CONTENT ADMIN USERS-->
    </div>
