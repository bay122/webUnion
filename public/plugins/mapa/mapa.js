...
var MapaFormulario = Class({
    ...
    */
     ...
     */
    places : function(){
        console.warn("utilizando places")
        var yo = this;
    ...
    updateRadioROundArea: function(nuevo_radio){
        this.area_circular.setRadius(parseInt(nuevo_radio));
    },
