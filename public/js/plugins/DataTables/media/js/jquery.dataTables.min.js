...
function calculate_date(e){var t=e.substring(0,11),a=e.substring(11,16);if(""===(e=t.replace(" ",""))||"---"===e)return 0;if(e.indexOf(".")>0)var r=e.split(".");else r=e.split("/");if(r[2])var u=r[2];else u=0;var l=r[1];1==l.length&&(l=0+l);var n=r[0];1==n.length&&(n=0+n);var c=a.split(":");return c[0]?hour=c[0]:hour=0,c[1]?minute=c[1]/60:minute=0,1*(u+l+n+hour+minute)}jQuery.fn.dataTableExt.oSort["eu_date-asc"]=function(e,t){return x=calculate_date(e),y=calculate_date(t),x<y?-1:x>y?1:0},jQuery.fn.dataTableExt.oSort["eu_date-desc"]=function(e,t){return x=calculate_date(e),y=calculate_date(t),x<y?1:x>y?-1:0};